...
const FONT_FAMILIES: { value: FontFamily; label: string; desc: string; cssVar: string }[] = [
  ...
  { value: "fira-sans", label: "Fira Sans", desc: "mozilla humanist sans", cssVar: "var(--font-fira-sans)" },
  { value: "figtree", label: "Figtree", desc: "friendly geometric", cssVar: "var(--font-figtree)" },
  ...
  { value: "quicksand", label: "Quicksand", desc: "rounded geometric", cssVar: "var(--font-quicksand)" },
  ...
  { value: "red-hat-mono", label: "Red Hat Mono", desc: "red hat mono", cssVar: "var(--font-red-hat-mono)" },
  ...
  { value: "rubik", label: "Rubik", desc: "modern rounded sans", cssVar: "var(--font-rubik)" },
  ...
  { value: "urbanist", label: "Urbanist", desc: "modern geometric", cssVar: "var(--font-urbanist)" },
