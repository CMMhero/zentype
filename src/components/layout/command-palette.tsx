...
const FONT_FAMILIES: { value: FontFamily; label: string; desc: string; cssVar: string }[] = [
  { value: "advent-pro", label: "Advent Pro", desc: "geometric sans", cssVar: "var(--font-advent-pro)" },
  { value: "alfa-slab-one", label: "Alfa Slab One", desc: "slab display", cssVar: "var(--font-alfa-slab-one)" },
  ...
  { value: "asap", label: "Asap", desc: "geometric sans", cssVar: "var(--font-asap)" },
  { value: "atkinson-hyperlegible", label: "Atkinson Hyperlegible", desc: "dyslexic-friendly", cssVar: "var(--font-atkinson-hyperlegible)" },
  { value: "baloo-2", label: "Baloo 2", desc: "rounded sans", cssVar: "var(--font-balance)" },
  ...
  { value: "caveat", label: "Caveat", desc: "handwriting", cssVar: "var(--font-caveat)" },
  { value: "chivo", label: "Chivo", desc: "grotesque sans", cssVar: "var(--font-chivo)" },
  ...
  { value: "comfortaa", label: "Comfortaa", desc: "rounded sans", cssVar: "var(--font-comfortaa)" },
  { value: "coming-soon", label: "Coming Soon", desc: "handwriting", cssVar: "var(--font-coming-soon)" },
  { value: "courier-prime", label: "Courier Prime", desc: "courier variant", cssVar: "var(--font-courier-prime)" },
  { value: "crimson-pro", label: "Crimson Pro", desc: "old-style serif", cssVar: "var(--font-crimson-pro)" },
  { value: "dancing-script", label: "Dancing Script", desc: "script", cssVar: "var(--font-dancing-script)" },
  { value: "dm-sans", label: "DM Sans", desc: "geometric sans", cssVar: "var(--font-dm-sans)" },
  { value: "domine", label: "Domine", desc: "transitional serif", cssVar: "var(--font-domine)" },
  { value: "exo-2", label: "Exo 2", desc: "geometric sans", cssVar: "var(--font-exo-2)" },
  { value: "figtree", label: "Figtree", desc: "geometric sans", cssVar: "var(--font-figtree)" },
  { value: "fira-code", label: "Fira Code", desc: "monospace ligatures", cssVar: "var(--font-fira-code)" },
  { value: "fira-sans", label: "Fira Sans", desc: "humanist sans", cssVar: "var(--font-fira-sans)" },
  { value: "fredoka", label: "Fredoka", desc: "rounded sans", cssVar: "var(--font-fredoka)" },
  { value: "geist", label: "Geist", desc: "variable sans", cssVar: "var(--font-geist)" },
  { value: "geist-mono", label: "Geist Mono", desc: "variable mono", cssVar: "var(--font-geist-mono)" },
  { value: "gelasio", label: "Gelasio", desc: "Georgia variant", cssVar: "var(--font-gelasio)" },
  { value: "google-sans", label: "Google Sans", desc: "google sans", cssVar: "var(--font-google-sans)" },
  { value: "ibm-plex-mono", label: "IBM Plex Mono", desc: "ibm mono", cssVar: "var(--font-ibm-plex-mono)" },
  { value: "ibm-plex-sans", label: "IBM Plex Sans", desc: "ibm sans", cssVar: "var(--font-ibm-plex-sans)" },
  { value: "inconsolata", label: "Inconsolata", desc: "condensed mono", cssVar: "var(--font-inconsolata)" },
  { value: "inter", label: "Inter", desc: "variable sans", cssVar: "var(--font-inter)" },
  { value: "itim", label: "Itim", desc: "casual sans", cssVar: "var(--font-itim)" },
  { value: "iosevka", label: "Iosevka", desc: "code ligature mono", cssVar: "var(--font-iosevka)" },
  { value: "jetbrains-mono", label: "JetBrains Mono", desc: "code mono", cssVar: "var(--font-jetbrains-mono)" },
  { value: "josefin-sans", label: "Josefin Sans", desc: "geometric sans", cssVar: "var(--font-josefin-sans)" },
  { value: "karla", label: "Karla", desc: "grotesque sans", cssVar: "var(--font-karla)" },
  { value: "lato", label: "Lato", desc: "humanist sans", cssVar: "var(--font-lato)" },
  { value: "lexend", label: "Lexend", desc: "readability sans", cssVar: "var(--font-lexend)" },
  { value: "lobster", label: "Lobster", desc: "display script", cssVar: "var(--font-lobster)" },
  { value: "lora", label: "Lora", desc: "calligraphy serif", cssVar: "var(--font-lora)" },
  { value: "manrope", label: "Manrope", desc: "grotesque sans", cssVar: "var(--font-manrope)" },
  { value: "merriweather", label: "Merriweather", desc: "sturdy serif", cssVar: "var(--font-merriweather)" },
  { value: "mona-sans", label: "Mona Sans", desc: "variable sans", cssVar: "var(--font-mona-sans)" },
  { value: "montserrat", label: "Montserrat", desc: "geometric sans", cssVar: "var(--font-montserrat)" },
  { value: "noto-sans", label: "Noto Sans", desc: "universal sans", cssVar: "var(--font-noto-sans)" },
  { value: "noto-serif", label: "Noto Serif", desc: "universal serif", cssVar: "var(--font-noto-serif)" },
  { value: "nunito", label: "Nunito", desc: "rounded sans", cssVar: "var(--font-nunito)" },
  { value: "nunito-sans", label: "Nunito Sans", desc: "rounded sans", cssVar: "var(--font-nunito-sans)" },
  { value: "opendyslexic", label: "OpenDyslexic", desc: "dyslexic-friendly", cssVar: "var(--font-opendyslexic)" },
  ...
  { value: "oxygen", label: "Oxygen", desc: "humanist sans", cssVar: "var(--font-oxygen)" },
  { value: "pacifico", label: "Pacifico", desc: "brush script", cssVar: "var(--font-pacifico)" },
  { value: "petrona", label: "Petrona", desc: "old-style serif", cssVar: "var(--font-petrona)" },
  { value: "playfair-display", label: "Playfair Display", desc: "didone serif", cssVar: "var(--font-playfair-display)" },
  ...
  { value: "pt-sans", label: "PT Sans", desc: "humanist sans", cssVar: "var(--font-pt-sans)" },
  { value: "pt-serif", label: "PT Serif", desc: "transitional serif", cssVar: "var(--font-pt-serif)" },
  { value: "quicksand", label: "Quicksand", desc: "rounded sans", cssVar: "var(--font-quicksand)" },
  { value: "raleway", label: "Raleway", desc: "elegant sans", cssVar: "var(--font-raleway)" },
  { value: "red-hat-display", label: "Red Hat Display", desc: "display sans", cssVar: "var(--font-red-hat-display)" },
  { value: "red-hat-mono", label: "Red Hat Mono", desc: "mono", cssVar: "var(--font-red-hat-mono)" },
  { value: "roboto", label: "Roboto", desc: "neo-grotesk sans", cssVar: "var(--font-roboto)" },
  { value: "roboto-flex", label: "Roboto Flex", desc: "variable sans", cssVar: "var(--font-roboto-flex)" },
  { value: "roboto-mono", label: "Roboto Mono", desc: "mono", cssVar: "var(--font-roboto-mono)" },
  { value: "roboto-slab", label: "Roboto Slab", desc: "slab serif", cssVar: "var(--font-roboto-slab)" },
  { value: "rubik", label: "Rubik", desc: "rounded sans", cssVar: "var(--font-rubik)" },
  { value: "sarabun", label: "Sarabun", desc: "thai sans", cssVar: "var(--font-sarabun)" },
  { value: "shantell-sans", label: "Shantell Sans", desc: "handwriting sans", cssVar: "var(--font-shantell-sans)" },
  { value: "sora", label: "Sora", desc: "geometric sans", cssVar: "var(--font-sora)" },
  { value: "source-code-pro", label: "Source Code Pro", desc: "code mono", cssVar: "var(--font-source-code-pro)" },
  { value: "space-grotesk", label: "Space Grotesk", desc: "monospace-inspired", cssVar: "var(--font-space-grotesk)" },
  { value: "space-mono", label: "Space Mono", desc: "monospace", cssVar: "var(--font-space-mono)" },
  { value: "titillium-web", label: "Titillium Web", desc: "technical sans", cssVar: "var(--font-titillium-web)" },
  { value: "ubuntu", label: "Ubuntu", desc: "humanist sans", cssVar: "var(--font-ubuntu)" },
  { value: "ubuntu-mono", label: "Ubuntu Mono", desc: "mono", cssVar: "var(--font-ubuntu-mono)" },
  { value: "urbanist", label: "Urbanist", desc: "geometric sans", cssVar: "var(--font-urbanist)" },
  { value: "victor-mono", label: "Victor Mono", desc: "cursive mono", cssVar: "var(--font-victor-mono)" },
  { value: "work-sans", label: "Work Sans", desc: "variable sans", cssVar: "var(--font-work-sans)" },
];
