        ...
        <section>
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            ...
            <FeatureCard
              ...
              description="Net and raw WPM, accuracy, consistency (how steady your speed stays), character breakdown. Per-second timeline charts with wpm burst and error bars, plus personal bests per mode."
            />
            <FeatureCard
