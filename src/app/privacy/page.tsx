  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-10">
      ...
      <div className="prose prose-sm dark:prose-invert mt-8 max-w-none prose-p:text-sm prose-p:leading-relaxed prose-li:text-sm">
        ...
        <p>
          To authenticate you, sync results across devices, render profiles/leaderboards, compute XP/achievements, and remember preferences. We do not sell your data or show ads.
        </p>

        <h2 className="text-base font-semibold mt-6">3. Sharing</h2>
        <p>
          Public profiles and leaderboards are visible to anyone with the link. We share data only with service providers (Supabase, Upstash) as needed to operate the app. We do not share with advertisers.
        </p>
